...
def run_experiment_b(num_epochs: int = 20):
    device = get_m1_device()
    print("\n=================================================================")
    print("      EXPERIMENT B — MEDIUM CNN (64 -> 128 -> 128 | ~257K Params)  ")
    print("=================================================================")
    ...
    print(f"\n[✓] Experiment B Training Complete! Best Val Acc: {best_val_acc:.2f}%")
    ...
    results_file = Path("experiments/results_experiment_b.json")
    save_summary = {
        "model_name": "Experiment B (Medium CNN)",
        "trainable_params": trainable_params,
    ...
    print(f"[✓] Saved Experiment B evaluation results to '{results_file}'")
    return save_summary


if __name__ == "__main__":
    run_experiment_b(num_epochs=20)
